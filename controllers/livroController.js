...
exports.home = async (req, res) => {
    ...
    return res.render('admin/livro/home', { title: 'Página inicial', results });
};

exports.new = (req, res) => {
    return res.render('admin/livro/new', { title: 'Adicionar livro' })
};
...
exports.edit = async (req, res) => {
    ...
    return res.render('admin/livro/edit', { title: 'Editar livro', result });
};
